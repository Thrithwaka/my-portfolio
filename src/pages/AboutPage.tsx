...
import { ResearchesManager } from './admin/ResearchesManager';
      ...
      <div ref={containerRef} className="relative h-[450vh]">
        {aboutLoading ? (
          ...
          <>
              ...
              >
                ...
                >
                  <div className="text-center mb-12 md:mb-16 space-y-4">
                    ...
                    <h2 className="text-3xl md:text-77xl font-black tracking-tighter uppercase text-black dark:text-white leading-none">
            ...
            <VisualEditorWrapper isAdmin={isAdmin} onEdit={() => setActiveEditor('research')} label="Manage Research">
              <motion.section 
